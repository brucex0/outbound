...
const messages: Record<SupportedAILocale, Record<LiveCoachMoment, { key: string; text: string }>> = {
  en: {
    ...
    segment_countdown: { key: "countdown.one", text: "1" },
    finish_opportunity: { key: "coach.strong_finish", text: "Stay composed and let the effort rise gradually." },
    race_start_restraint: { key: "coach.early_settle", text: "Ease off a touch. Let your body settle into the run." },
    race_pace_locked: { key: "progress.steady", text: "Keep this steady rhythm." },
    race_halfway_assessment: { key: "progress.halfway", text: "Halfway there. Stay patient and steady." },
    race_late_fade: { key: "coach.rebuild_rhythm", text: "Reset your posture and gently bring the rhythm back." },
    race_late_strength: { key: "coach.strong_finish", text: "Stay composed and let the effort rise gradually." },
    race_final_kilometer: { key: "coach.strong_finish", text: "Stay composed and let the effort rise gradually." },
  ...
  es: {
    ...
    race_start_restraint: { key: "coach.early_settle", text: "Afloja un poco y entra en ritmo sin prisas." },
    race_pace_locked: { key: "progress.steady", text: "Mantén este ritmo estable." },
    race_halfway_assessment: { key: "progress.halfway", text: "Ya estás a mitad. Mantén la paciencia y la constancia." },
    race_late_fade: { key: "coach.rebuild_rhythm", text: "Recoloca la postura y recupera el ritmo poco a poco." },
    race_late_strength: { key: "coach.strong_finish", text: "Mantén la calma y aumenta el esfuerzo gradualmente." },
    race_final_kilometer: { key: "coach.strong_finish", text: "Mantén la calma y aumenta el esfuerzo gradualmente." },
  ...
  "zh-Hans": {
    ...
    race_start_restraint: { key: "coach.early_settle", text: "稍微收一点，别着急，让身体慢慢进入节奏。" },
    race_pace_locked: { key: "progress.steady", text: "保持现在的稳定节奏。" },
    race_halfway_assessment: { key: "progress.halfway", text: "已经过半，保持耐心和稳定。" },
    race_late_fade: { key: "coach.rebuild_rhythm", text: "调整一下跑姿，放松地把节奏带回来。" },
    race_late_strength: { key: "coach.strong_finish", text: "保持从容，逐步提升强度。" },
    race_final_kilometer: { key: "coach.strong_finish", text: "保持从容，逐步提升强度。" },
