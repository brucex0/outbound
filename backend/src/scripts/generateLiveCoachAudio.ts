        ...
        const result = await generateWithRetry(
          () => resolved.provider.generateCue({
            ...
            compiledContext: {
              ...
              coachingProfile: {
                fitnessLevel: null, weeklyVolumeKilometers: null, preferredPaceSecondsPerKilometer: null,
                strengths: [], weaknesses: [], goals: [], records: {}, recentMemorySummary: {},
              },
              workout: null,
              clientWorkout: null,
              readiness: null,
              ...
              runnerBeliefs: [],
              recentTraining: {
                sevenDayActivities: [], sevenDaySummary: {}, twentyEightDaySummary: {}, recentWorkoutFeedback: [],
              },
              environment: { timeZoneIdentifier: null, indoor: false, approximateLocation: null, weather: null },
