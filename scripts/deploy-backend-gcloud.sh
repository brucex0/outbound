...
Environment overrides:
  ...
  LIVE_COACH_PAID_MODE_READY      default: false; set true only after RevenueCat launch setup
...
LIVE_COACH_PAID_MODE_READY="${LIVE_COACH_PAID_MODE_READY:-false}"
...
environment_bindings=(
  ...
  "LIVE_COACH_PAID_MODE_READY=$LIVE_COACH_PAID_MODE_READY"
