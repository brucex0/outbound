...
enum TrainingPlanLibrary {
    static let outboundPlanStandardsSource = TrainingPlanSource(
        ...
        importNotes: "Uses original Plainstride workout tables shaped by common guidance conventions: mostly easy running, one controlled quality day, progressive long runs, cutback weeks, and a taper for race plans."
    )
