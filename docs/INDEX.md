...
| Activity start and live-run prototype | `docs/prototypes/activity-start-live-wireframe.html` | Clickable unified launch dock with planned, freestyle, distance, time, and calorie goals; value overlays; music, Live Track, and run setup; immediate start; live metrics; and expandable map |
