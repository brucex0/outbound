...
| Run Group creation, membership roles, Group notices, recurring Group runs, and moderation | `docs/run-groups.md` | Brainstorm and design-options doc for un-deferring Group creation and administration, with current-state findings, formal-club versus informal-crew and Circle-versus-Group decisions, data/API direction, and rollout slices |
| Invitation-only Circles, weekly themes, personal commitments, shared workouts, Cheers, Circle management, analytics, and MVP handoff | `docs/your-circle.md` | Canonical product and implementation contract for Your Circle |
