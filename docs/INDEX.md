...
| Activity start and live-run prototype | `docs/prototypes/activity-start-live-wireframe.html` | Clickable flat launch dock with planned, freestyle, distance, time, and calorie goals; editable detail cards and custom values; contextual Today/Start navigation; music, Live Track, and run setup; immediate start; live metrics; and expandable map |
