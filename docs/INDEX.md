...
| Consolidated private and community Groups, creation, trust policies, capabilities, UX, data, APIs, migration, and rollout | `docs/run-groups.md` | Canonical target contract that replaces Circle and Group with one Group product while preserving server-enforced workout privacy |
