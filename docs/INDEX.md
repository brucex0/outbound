...
| Activity start and live-run prototype | `docs/prototypes/activity-start-live-wireframe.html` | Clickable one-tap GO direction with a preselected planned-workout card, peer run modes, contextual content, countdown, live metrics, and expandable map |
