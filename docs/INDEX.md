...
| Activity launch dock, contextual Today/Start decision, goal defaults, countdown, and live-run behavior | `docs/activity-launch-live-ux.md` | Approved UX contract for the flat Today launch dock and recording transition; production Swift is pending |
