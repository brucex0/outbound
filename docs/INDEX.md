...
| Gemini start planning, streaming Google live-coach TTS, planned/fixed audio, trust, and rollout | `docs/live-coach-operations.md` | Approved model/voices, HTTP/2/gRPC audio path, 850 ms fallback, prewarming, review workflow, Google ADC, and rollout semantics |
