...
| Provider-agnostic AI live coaching audio, context compilation, routing, Alibaba adapter, fixed voice packs, and server-generated playback | `docs/superpowers/plans/2026-08-27-provider-agnostic-live-coaching-audio.md` | Full file-level handoff plan for replacing Apple speech with server-generated audio while keeping provider/model selection behind a market-, policy-, latency-, health-, and cost-aware backend boundary |
