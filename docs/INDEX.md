...
| Google live-coach TTS voices, fixed-pack generation, ES256 manifest trust, and staged rollout operations | `docs/live-coach-operations.md` | Approved female/male voices, 156-file review workflow, Google ADC, signing-key ownership, and rollout semantics |
| Live-coach planner, device, backend, and TTS data boundaries | `docs/live-coach-data-boundaries.md` | Exact fields at each boundary, what Gemini and Google TTS receive, and retention/logging rules |
