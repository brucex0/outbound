...
| Live-coach device, backend, TTS, and optional LLM data boundaries | `docs/live-coach-data-boundaries.md` | Exact fields at each boundary, what Google TTS receives, retention/logging rules, and the disabled planner allowlist |
