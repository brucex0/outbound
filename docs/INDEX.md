...
| Alibaba live-coach model and voice map, fixed-pack inventory/generation, ES256 manifest trust, and staged rollout operations | `docs/live-coach-operations.md` | Approved six voices, 612-file review workflow, signing-key ownership, and exact `fixed_only`/dynamic rollout semantics |
