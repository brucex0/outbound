...
| Private Circles, flexible weekly focus, Cheers, Circle management, privacy, analytics, and MVP handoff | `docs/your-circle.md` | Canonical product and implementation contract for Your Circle |
