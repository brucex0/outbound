...
| Activity launch dock, stable tab decision, goal defaults, countdown, and live-run behavior | `docs/activity-launch-live-ux.md` | Approved UX contract for the flat Today launch dock and recording transition; production Swift is pending |
...
| Activity start and live-run prototype | `docs/prototypes/activity-start-live-wireframe.html` | Clickable flat launch dock with peer goal modes, learned defaults, stable Social/Today/Me navigation, direct Start, setup overlays and toggles, countdown, goal-specific live metrics, and expandable map |
