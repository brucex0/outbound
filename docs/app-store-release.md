...
- Public legal pages are `https://plainstride.ai/terms` and `https://plainstride.ai/privacy`. The sign-in disclosure and Settings → Legal link to them.
