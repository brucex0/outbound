...
- `Domains/Social/SocialHomeView.swift`: production Social home and Connections UI. Social home retains upcoming group runs, joined clubs, activity posts, referrals, and Cheers; the persistent Connections destination adds authenticated listing, search, request, accept, decline/cancel, and removal flows.
