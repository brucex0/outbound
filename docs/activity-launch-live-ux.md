...
- The compact chooser opens only from the value card and supports presets plus an embedded, unit-labeled custom field for Distance, Time, and Calories.
