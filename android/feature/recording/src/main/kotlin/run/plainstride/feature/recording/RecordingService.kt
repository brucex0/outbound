...
class RecordingService : Service() {
    ...
    companion object {
        ...
        private const val ACTION_START = "run.plainstride.recording.START"
        private const val ACTION_RECOVER = "run.plainstride.recording.RECOVER"
        private const val ACTION_PAUSE = "run.plainstride.recording.PAUSE"
        private const val ACTION_RESUME = "run.plainstride.recording.RESUME"
        private const val ACTION_FINISH = "run.plainstride.recording.FINISH"
        private const val ACTION_SAVED = "run.plainstride.recording.SAVED"
        private const val ACTION_DISCARD = "run.plainstride.recording.DISCARD"
