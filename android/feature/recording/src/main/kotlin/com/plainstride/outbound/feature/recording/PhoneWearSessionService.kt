...
import com.plainstride.outbound.core.model.activity.*
...
import com.plainstride.outbound.core.data.*
...
class PhoneWearSessionService : WearableListenerService() {
    ...
    private suspend fun importFinished(state: SessionStateEnvelope) {
        ...
        val saved = RecordedActivityFactory.create(RecordedActivityDraft(
            sessionId = state.sessionId, accountId = accountId, type = com.plainstride.outbound.core.model.activity.ActivityType.running,
