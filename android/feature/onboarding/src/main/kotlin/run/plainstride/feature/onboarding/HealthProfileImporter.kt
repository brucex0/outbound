...
class HealthConnectProfileImporter @Inject constructor(private val health: HealthConnectRepository) : HealthProfileImporter {
    override suspend fun import(): Result<ImportedHealthProfile> = when (val result = health.importOnboardingActivities()) {
