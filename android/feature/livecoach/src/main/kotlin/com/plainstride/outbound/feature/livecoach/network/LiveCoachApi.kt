...
interface LiveCoachApi {
    ...
    @Streaming @POST("v1/live-coach/sessions/{id}/phrases/{phraseId}/audio") suspend fun phraseAudio(@Header("Authorization") authorization: String, @Path("id") id: String, @Path("phraseId") phraseId: String): Response<ResponseBody>
