package run.plainstride.feature.settings
...
import run.plainstride.core.designsystem.PlainstrideThemeId
import run.plainstride.core.designsystem.plainstrideThemeColors
...
@Composable private fun ProfileDialog(account: run.plainstride.core.network.AccountDto?, dismiss: () -> Unit, save: (String, String?, String?) -> Unit) {
